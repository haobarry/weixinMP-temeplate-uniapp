<template>
  <view v-if="show" class="badge-box"
        :class="[
          isDot ? 'badge-box-dot' : '',
          size == 'mini' ? 'badge-box-mini' : '',
          type ? 'badge-box--bg--' + type : '']"
        :style="[{
          top: offset[0] + 'rpx',
          right: offset[1] + 'rpx',
 ...
 * @property {Object} borderStyle 关于border的样式
...
const show = computed(() => {
  ...
  return !(props.count === 0 && props.showZero === false);
})
